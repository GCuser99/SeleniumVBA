Attribute VB_Name = "test_Attributes_Properties"
...
Sub test_element_attributes_and_properties()
    ...
    filepath = "C:/Users/waite/Documents/finance/financial model/mike's code/scraping/html.html"
    ...
    'Note that after browser parses html, the checked property is created for all three checkboxes
...
Sub test_element_aria()
    ...
    'str = "<!DOCTYPE html><html><body><button class='xyz'><span class='abc' aria-label='Unlike'></span></button></body></html>"
