...
'ATTENTION!!!!
'
'GCUser99: The default in this version of SeleniumVBA is set NOT to automaticaaly check for Driver/Browser version alignment
...
'when StartChrome and StartEdge methods are invoked,
...
'---------------------------------------------------------------------------------------------------------------
'
'Another option is to run the subroutine below, which will check compatibility and install if needed.
'
'---------------------------------------------------------------------------------------------------------------
