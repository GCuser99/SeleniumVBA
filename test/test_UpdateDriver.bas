...
Sub test_AutoUpdateDrivers()
    ...
    'and if not compatible, to automatically download and install drivers, then user must modify the following
    ...
    Driver.Chrome 'here is where the version alignment checking and fixing happens - you will be prompted to install if needed
    Driver.Edge 'here is where the version alignment checking and fixing happens - you will be prompted to install if needed
