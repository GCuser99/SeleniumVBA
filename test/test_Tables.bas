...
Sub test_table_to_array()
    ...
    htmlStr = "<html><body><table border='l' id='mytable'><thead><tr><th>head 1</th><th>head 2</th><th>head 3</th></tr></thead><tbody><tr><td>Deuces:</td><td colspan='2'>2</td></tr><tr><td>Choose</td><td>Option</td><td><table border='l'><tbody><tr><td>A</td><td>B</td></tr><tr><td>C</td><td>D</td></tr></tbody></table></td></tr><tr><td>Sky</td><td rowspan='3'>Is</td><td>Blue</td></tr><tr><td>Less</td><td>More</td></tr><tr><td>Big</td><td rowspan='2'>Better</td></tr><tr><td>I</td><td>Feel</td></tr></tbody><tfoot><tr><td colspan='3'>footer content</td></tr></tfoot></table></body></html>"
    ...
    Debug.Print ""
    Debug.Print "With default createSpanData=False:"
    For i = 1 To UBound(v, 1)
        If Not IsArray(v(i, 3)) Then
            Debug.Print v(i, 1), v(i, 2), v(i, 3)
        Else
